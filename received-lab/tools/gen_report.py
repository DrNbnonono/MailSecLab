...
<a href="#p3c">Phase 3C · 解析器差分</a><a href="#find">核心结论</a><a href="#eseries">E 系列 · 限制面</a><a href="#fseries">F 系列 · 安全后果</a><a href="#gseries">G 系列 · 纠错归因</a><a href="#hseries">H 系列 · 信任边界</a><a href="#iseries">I 系列 · 走私/链伪造</a><a href="#jseries">J 系列 · DKIM 交互</a><a href="#kseries">K 系列 · 验证器差分</a><a href="#next">后续方向</a>
</nav>
...
<section id="kseries">
<h2>16 · K 系列 — DKIM 验证器差分（2026-09-07）</h2>
<p class="note">同一签名（同字节、同密钥）× 四个验证器：dkimpy / perl Mail::DKIM / go-msgauth / rspamd（经 lab dnsmasq 提供 DNS）。完整记录含 opendkim-testmsg 损坏、TXT 255 字节拆分、canary 定位等，见 <code>results/k-series/RECORD.md</code>。</p>
<table class="matrix">
